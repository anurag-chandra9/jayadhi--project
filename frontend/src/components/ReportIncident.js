...
const ReportIncident = () => {
    ...
    const fieldIcons = {
        companyName: <Landmark size={14} />,
        contactPersonName: <User size={14} />,
        contactEmail: <MailCheck size={14} />,
        contactPhone: <Phone size={14} />,
        incidentDate: <CalendarDays size={14} />,
        incidentTime: <Clock size={14} />,
        severityLevel: <AlertTriangle size={14} />,
        incidentTitle: <FileText size={14} />,
        status: <Check size={14} />,
        incidentType: <Shield size={14} />,
    ...
    const renderField = (field) => {
        ...
        return (
            <input
                ...
                placeholder={
                    field === 'financialLoss' ? 'Enter amount in Rupees' :
        ...
        <div className="report-incident-page">
            ...
            {status && (
                <div className={`status-message ${status.success ? 'success' : 'error'}`}>
                    <p>
                        {status.success ? (
                            <CheckCircle color="green" size={18} style={{ marginRight: '5px' }} />
                        ) : (
                            <XCircle color="red" size={18} style={{ marginRight: '5px' }} />
                        )}
                        {status.message}
                    </p>
                    {status.success && (
