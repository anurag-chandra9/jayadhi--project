          ...
          {status.success && (
            <div className="success-details">
              ...
              <p className="download-link">
                <a href={`${process.env.NODE_ENV === 'production' ? (process.env.REACT_APP_API_URL || 'https://jayadhi-project-hyrv.onrender.com') : (process.env.REACT_APP_API_URL || 'http://localhost:3000')}/reports/${status.reportFileName}`} target="_blank" rel="noreferrer" className="pdf-link">
