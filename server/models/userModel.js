...
const userSchema = new mongoose.Schema({
    ...
    // --- FIX: Change enum values to lowercase 'user' and 'admin' ---
    role: {
        type: String,
        enum: ['user', 'admin'], // <-- CRITICAL FIX: Changed to lowercase 'user' and 'admin'
        default: 'user'         // <-- CRITICAL FIX: Changed default to lowercase 'user'
    },
    lastLogin: {
        type: Date,
        default: Date.now
